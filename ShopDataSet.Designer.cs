...
namespace ManagementSystem {
    ...
    public partial class ShopDataSet : global::System.Data.DataSet {
        ...
        public partial class MembersDataTable : global::System.Data.TypedTableBase<MembersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MembersRow AddMembersRow(string firstname, string lastname, string username, string password, string contactnumber) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MembersRow FindByuserId(int userId) {
        ...
        public partial class MembersRow : global::System.Data.DataRow {
            ...
            public int userId {
                get {
                    return ((int)(this[this.tableMembers.userIdColumn]));
                }
                set {
...
namespace ManagementSystem.ShopDataSetTableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Members] ([firstname], [lastname], [username], [password], [contactnumber]) VALUES (@firstname, @lastname, @username, @password, @contactnumber);
SELECT userId, firstname, lastname, username, password, contactnumber FROM Members WHERE (userId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Members] SET [firstname] = @firstname, [lastname] = @lastname, [username] = @username, [password] = @password, [contactnumber] = @contactnumber WHERE (([userId] = @Original_userId) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_contactnumber = 1 AND [contactnumber] IS NULL) OR ([contactnumber] = @Original_contactnumber)));
SELECT userId, firstname, lastname, username, password, contactnumber FROM Members WHERE (userId = @userId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ManagementSystem.Properties.Settings.Default.ShopConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userId, firstname, lastname, username, password, contactnumber FROM dbo.Me" +
                "mbers";
        ...
        public virtual int Fill(ShopDataSet.MembersDataTable dataTable) {
        ...
        public virtual ShopDataSet.MembersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShopDataSet.MembersDataTable dataTable = new ShopDataSet.MembersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShopDataSet.MembersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_userId, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_contactnumber) {
        ...
        public virtual int Insert(string firstname, string lastname, string username, string password, string contactnumber) {
            if ((firstname == null)) {
        ...
        public virtual int Update(string firstname, string lastname, string username, string password, string contactnumber, int Original_userId, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_contactnumber, int userId) {
            if ((firstname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, string username, string password, string contactnumber, int Original_userId, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_contactnumber) {
            return this.Update(firstname, lastname, username, password, contactnumber, Original_userId, Original_firstname, Original_lastname, Original_username, Original_password, Original_contactnumber, Original_userId);
        }
    }
